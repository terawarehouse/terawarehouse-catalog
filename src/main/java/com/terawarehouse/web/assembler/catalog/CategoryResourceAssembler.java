 ...
 */
@Component
public class CategoryResourceAssembler extends AbstractBusinessResourceAssembler<CategoryDto> implements RepresentationModelAssembler<CategoryDto, EntityModel<CategoryDto>> {
