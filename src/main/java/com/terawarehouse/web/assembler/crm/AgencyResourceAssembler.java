 ...
 */
package com.terawarehouse.web.assembler.crm;
 ...
 */
@Component
public class AgencyResourceAssembler extends AbstractBusinessResourceAssembler<AgencyDto> {

    public AgencyResourceAssembler() {
